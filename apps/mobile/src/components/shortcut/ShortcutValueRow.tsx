 ...
 * 値の行の上下の余白（pt）
 *
 * 隣り合う値の間はこの余白の2倍になる。広すぎると値の多いショートカットが縦に間延びし、
 * 一覧を見渡しにくくなるため、値名の行が区切りとして読み取れる程度に詰める。
 * タップ対象としての高さもここで確保する。値が1行でも、値名と値の行高さ（スマートフォンで18+21pt）に
 * この余白を足して最小タップ領域の44ptを下回らないこと。
 */
